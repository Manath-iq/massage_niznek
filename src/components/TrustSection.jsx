...
const REVIEWS = [
    ...
    },
    {
        ...
        rating: 5,
        date: 'Март 2026',
        text: 'Делала ручной массаж на всё тело — уходила как на крыльях. Очень грамотный подход: сначала спросили про проблемные зоны, потом проработали именно то, что болело. Буду приходить регулярно!',
    },
    {
        name: 'Гузель М.',
        rating: 5,
        date: 'Февраль 2026',
        text: 'Миостимуляция в комплексе с прессотерапией — моя любимая комбинация. За месяц курса фигура реально стала чётче. Цены адекватные, запись удобная через WhatsApp. Отличный салон!',
    },
];
